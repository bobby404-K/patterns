...
## 💡 Intuition
In this pattern, we create an inverted letter triangle. Each row starts from `A` and continues up to $(N - i)$ letters, with the number of characters decreasing row by row.
